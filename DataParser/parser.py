...
class Parser:
    ...
    def parse(self):
        ...
        file = open('data_csv/data.csv','w', newline='')
        ...
        if obj['query']['results'] is not None:
            for i in obj['query']['results']['photo']:
                ...
                csvW.writerow([photo_id,latitude,longitude])
                #csvW.writerow('\n')
        else:
            print('result null')
def main():
